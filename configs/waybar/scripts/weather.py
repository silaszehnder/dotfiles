...
data[
    "text"
] = f"{weather['current_condition'][0]['temp_F']}°{WEATHER_SYMBOL[WWO_CODE[weather['current_condition'][0]['weatherCode']]]} {weather['weather'][0]['mintempF']}°/{weather['weather'][0]['maxtempF']}°"
...
for i, day in enumerate(weather["weather"]):
    ...
    for hour in day["hourly"]:
        ...
        data[
            "tooltip"
        ] += f"{format_time(hour['time'])} {WEATHER_SYMBOL[WWO_CODE[hour['weatherCode']]]} {format_temp(hour['FeelsLikeF'])} {hour['weatherDesc'][0]['value']}, {format_chances(hour)}\n"
